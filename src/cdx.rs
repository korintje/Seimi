...
#[cfg(feature="QUADCONST")]
if fs == "_x86_" && fs != "_CS3D"		// All 3D projects uses the second QUADCONST definition for both MAC and Windows
// littleEndian
...
enum CDXDatumID {
	...
	// Fonts.
	kCDXProp_FontTable,						// 0x0100 A list of fonts used in the document. (CDXFontTable)

	// Coordinates.
	kCDXProp_2DPosition,					// 0x0200 The 2D location (in the order of vertical and horizontal locations) of an object. (CDXPoint2D)
	...
	// Colors.
	kCDXProp_ColorTable,					// 0x0300 The color palette used throughout the document. (CDXColorTable)
	...
	// Atom properties.
	kCDXProp_Node_Type,							// 0x0400 The type of a node object. (INT16)
	...
	kCDXProp_Atom_Isotope,						// 0x0420 The absolute isotopic mass of an atom (2 for deuterium, 14 for carbon-14). (INT16)
	...
	// Molecule properties.
	kCDXProp_Mole_Racemic,					// 0x0500 Indicates that the molecule is a racemic mixture. (CDXBoolean)
	...
	// Bond properties.
	kCDXProp_Bond_Order,					// 0x0600 The order of a bond object. (INT16)
	...
	// Text properties.
	kCDXProp_Text,							// 0x0700 The text of a text object. (CDXString)
	...
	// Document properties.
	kCDXProp_MacPrintInfo,					// 0x0800 The 120 byte Macintosh TPrint data associated with the CDX document object. Refer to Macintosh Toolbox manual for detailed description. (Unformatted)
	...
	// Window properties.
	kCDXProp_Window_IsZoomed,				// 0x0900 Signifies whether the main viewing window is zoomed (maximized). (CDXBooleanImplied)
	...
	kCDXProp_Graphic_Type,					// 0x0A00 The type of graphical object. (INT16)
	...
	kCDXProp_Arrow_HeadSize,				// 0x0A20 The size of the arrow's head. (INT16)
	...
	// Embedded pictures.
	kCDXProp_Picture_Edition,				// 0x0A60 The section information (SectionHandle) of the Macintosh Publish & Subscribe edition embedded in the CDX picture object. (Unformatted)
	...
	// Spectrum properties
	kCDXProp_Spectrum_XSpacing,				// 0x0A80 The spacing in logical units (ppm, Hz, wavenumbers) between points along the X-axis of an evenly-spaced grid. (FLOAT64)
	...
	// TLC properties
	kCDXProp_TLC_OriginFraction,			// 0x0AA0 The distance of the origin line from the bottom of a TLC Plate, as a fraction of the total height of the plate. (FLOAT64)
	...
	kCDXProp_TLC_Rf,						// 0x0AB0 The Retention Factor of an individual spot. (FLOAT64)
	...
	kCDXProp_NamedAlternativeGroup_TextFrame,		// 0x0B00 The bounding box of upper portion of the Named Alternative Group, containing the name of the group. (CDXRectangle)
	...
	kCDXProp_GeometricFeature,				// 0x0B80 The type of the geometrical feature (point, line, plane, etc.). (INT8)
	...
	// Reaction properties
	kCDXProp_ReactionStep_Atom_Map,			// 0x0C00 Represents pairs of mapped atom IDs; each pair is a reactant atom mapped to to a product atom. (CDXObjectIDArray)
	...
	kCDXProp_ObjectTag_Type,				// 0x0D00 The tag's data type. (INT16)
	...
	kCDXProp_Sequence_Identifier,			// 0x0E00 A unique (but otherwise random) identifier for a given Sequence object. (CDXString)

	// CDCrossReference properties
	kCDXProp_CrossReference_Container,		// 0x0F00 An external object containing (as an embedded object) the document containing the Sequence object being referenced. (CDXString)
	...
	kCDXProp_Template_PaneHeight,			// 0x1000 The height of the viewing window of a template grid. (CDXCoordinate)
	...
	kCDXProp_Group_Integral,				// 0x1100 The group is considered to be integral (non-subdivisible) if non-zero. (CDXBoolean)

	kCDXProp_SplitterPositions,				// 0x1FF0 An array of vertical positions that subdivide a page into regions. (CDXObjectIDArray)
...
const kCDXTagType_Unknown = "unknown"
const kCDXTagType_Query = "query"
const kCDXTagType_Rxn =	"reaction"
const kCDXTagType_Stereo = "stereo"
const kCDXTagType_Number = "number"
const kCDXTagType_Heading = "heading"
const kCDXTagType_IDTerm = "idterm"
const kCDXTagType_BracketUsage = "bracketusage"
const kCDXTagType_PolymerRepeat = "polymerrepeat"
const kCDXTagType_PolymerFlip = "polymerflip"
const kCDXTagType_Deviation = "deviation"
const kCDXTagType_Distance = "distance"
const kCDXTagType_Angle = "angle"
const kCDXTagType_Rf = "rf"
...
const kCDXLineHeight_Variable = 0
const kCDXLineHeight_Automatic = 1
